package com.imposterinc.mechanictinkerer.entity;
...
public class EntityCar extends Entity {
    ...
    public void setPositionAndRotation2(double par1, double par3, double par5, float par7, float par8, int par9)
    {
        if (this.isCarEmpty)
        {
            this.carPosRotationIncrements = par9 + 5;
        }
        else
        {
        ...
        this.carY = par3;
        this.carZ = par5;
        this.carYaw = (double)par7;
        this.carPitch = (double)par8;
...
//        if (this.worldObj.isClient && this.isCarEmpty)
//        {
//            if (this.carPosRotationIncrements > 0)
//            {
//                var6 = this.posX + (this.carX - this.posX) / (double)this.carPosRotationIncrements;
//                var8 = this.posY + (this.carY - this.posY) / (double)this.carPosRotationIncrements;
//                var24 = this.posZ + (this.carZ - this.posZ) / (double)this.carPosRotationIncrements;
//                var26 = MathHelper.wrapAngleTo180_double(this.carYaw - (double)this.rotationYaw);
//                this.rotationYaw = (float)((double)this.rotationYaw + var26 / (double)this.carPosRotationIncrements);
...
//                }
     ...
     */
    public void setisCarEmpty(boolean par1)
    {
        this.isCarEmpty = par1;
    }
